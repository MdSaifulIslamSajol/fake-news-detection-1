...
def compute_metrics(pred):
    ...
    precision = precision_score(lbls, prds, average='weighted')
    recall = recall_score(lbls, prds, average='weighted')
    f1 = f1_score(lbls, prds, average='weighted')
...
def evaluate_lstm(model, test_data, eval_batch_size, device, output_dir):
    ...
    return acc, eval_loss, precision, recall, f1
